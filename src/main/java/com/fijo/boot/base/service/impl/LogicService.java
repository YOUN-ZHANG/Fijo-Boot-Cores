...
import com.fijo.boot.base.repository.LogicRepository;
import com.fijo.boot.base.service.ILogicService;
import com.fijo.boot.constants.ApplicationConstants;
import com.fijo.boot.exceptions.InsertExistObjectException;
import com.fijo.boot.exceptions.UpdateNotExistObjectException;
import com.fijo.boot.util.CustomBeanUtil;
import com.fijo.boot.util.ObjectUtil;
//import com.fijo.boot.util.security.SecurityUtils;
